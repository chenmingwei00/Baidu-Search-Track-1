...
class ErnieFcSeqLabel(BaseModel):
    ...
    def net_forward(self,
        ...
        return loss,probs_start,probs_end,probs_ner,probs_crf
    ...
    def forward(self, fields_dict, phase):
        ...
        loss1, probs_start1, probs_end1, probs_ner1, probs_crf1=self.net_forward(text_src,
                                                                                 text_sent,
                                                                                 text_task,
                                                                                 label_start,
                                                                                 label_end,
        ...
        loss2, probs_start2, probs_end2, probs_ner2, probs_crf2 = self.net_forward(
                                                                                   text_src2,
                                                                                   text_sent2,
                                                                                   text_task2,
                                                                                   label_start2,
